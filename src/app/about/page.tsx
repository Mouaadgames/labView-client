function page() {
  return (
    <main className="relative flex flex-col items-center justify-center px-6 py-10 text-center">
      ...
      <div className="relative z-10 max-w-xl mt-20 fade-in-up delay-500 shadow-2xl rounded-xl border border-gray-200 p-6 backdrop-blur-lg">
        ...
        <p className="text-black text-lg leading-relaxed">
          ...
          <span className="text-purple-600 font-semibold text-nowrap"> Ait Ouflih Anouar</span>,
          <span className="text-pink-600 font-semibold text-nowrap"> El Barrik Mouaad</span>, and
          <span className="text-blue-600 font-semibold text-nowrap"> El Idrissi Abdellah</span>,
